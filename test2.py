...
print("Choose 5 skills that represent you from the list below (enter the corresponding number):\n")
    ...
    try:
        ...
        if 1 <= skill_index <= len(all_skills):
            ...
            if chosen_skill not in user_selected_skills:
                ...
                print("You already selected this skill. Choose another one.")
        else:
            print("Invalid number. Please choose a number within the valid range.")
    except ValueError:
        print("Invalid input. Please enter a number.")

print("\nYour selected skills are:", user_selected_skills)
...
print(f"The file has been updated with match scores in: {file_path}")
