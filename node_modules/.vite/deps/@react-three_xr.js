import {
  ...
  forwardHtmlEvents,
  forwardObjectEvents
} from "./chunk-BT6LVQI4.js";
import {
  GLTFLoader
} from "./chunk-MKHGEXLG.js";
import {
  MeshLineGeometry,
  MeshLineMaterial,
  tunnel
} from "./chunk-ZJ5AFZAX.js";
import {
  create,
  createStore,
  useStore
} from "./chunk-LFIYYLN3.js";
import {
  addEffect,
  context,
  createPortal,
  ...
  useThree
} from "./chunk-A3Z4RQ3U.js";
import "./chunk-VACWMP7W.js";
import {
  Box2,
  BoxGeometry,
  BufferAttribute,
...
async function injectEmulator(store, emulateOptions, alert) {
  ...
  const { emulate } = await import("./emulate-Q6A7DJ7Q.js");
  if (alert) {
...
function createXRVideoLayer(src, state, relativeTo, { invertStereo, layout, shape = "quad" }, properties = {}) {
  var _a;
  const space = getSpaceFromAncestors(relativeTo, state.origin, state.originReferenceSpace, matrixHelper2);
  if (space == null) {
    return void 0;
  }
...
function useXRControllerButtonEvent(controller, id, onChange) {
  const state = (0, import_react4.useRef)(void 0);
  useFrame(() => {
    var _a;
...
function useGrabPointer(spaceRef, pointerState, currentOptions, pointerType) {
  ...
  const pointer = (0, import_react6.useMemo)(() => createGrabPointer(() => store.getState().camera, spaceRef, pointerState, options, pointerType), [store, spaceRef, pointerState, options, pointerType]);
...
function useRayPointer(spaceRef, pointerState, currentOptions, pointerType) {
  ...
  Object.assign(options, currentOptions);
  const store = useStore2();
  const pointer = (0, import_react6.useMemo)(() => createRayPointer(() => store.getState().camera, spaceRef, pointerState, options, pointerType), [store, spaceRef, pointerState, options, pointerType]);
  useSetupPointer(pointer, currentOptions == null ? void 0 : currentOptions.makeDefault);
  return pointer;
}
function useLinesPointer(spaceRef, pointerState, currentOptions, pointerType) {
  ...
  Object.assign(options, currentOptions);
  const store = useStore2();
  const pointer = (0, import_react6.useMemo)(() => createLinesPointer(() => store.getState().camera, spaceRef, pointerState, options, pointerType), [store, spaceRef, pointerState, options, pointerType]);
  useSetupPointer(pointer, currentOptions == null ? void 0 : currentOptions.makeDefault);
  return pointer;
}
function useTouchPointer(spaceRef, pointerState, currentOptions, pointerType) {
  ...
  Object.assign(options, currentOptions);
  const store = useStore2();
  const pointer = (0, import_react6.useMemo)(() => createTouchPointer(() => store.getState().camera, spaceRef, pointerState, options, pointerType), [store, spaceRef, pointerState, options, pointerType]);
  useSetupPointer(pointer, currentOptions == null ? void 0 : currentOptions.makeDefault);
  return pointer;
}
